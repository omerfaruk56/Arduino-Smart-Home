#define ag_ismi "TurkTelekom_TD11A"
#define ag_sifresi "a9ekGdfE"
...
void sicaklik_yolla(float sicaklik){
 ...
 String yollanacakkomut = "GET /update?key=8UQUINI0DNMVVD28&field1=";   // Burada 64T0OS3R1OEAYUML yazan kısım bizim API Key den aldığımız Key. Siz buraya kendi keyinizi yazacaksınız.
